...
public class CassandraClient<K, T extends PersistentBase> {
  ...
  private String getMappingFamily(String pField){
    ...
    if (pField.indexOf(InfinispanStore.UNION_COL_SUFIX) > 0)
      family = this.cassandraMapping.getFamily(pField.substring(0,pField.indexOf(InfinispanStore.UNION_COL_SUFIX)));
    else
